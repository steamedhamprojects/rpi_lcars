...
class ScreenMain(LcarsScreen):
    def setup(self, all_sprites):
        ...
        # panel text
        all_sprites.add(LcarsText(colours.BLACK, (15, 44), "LCARS 105", 0.5),
                        layer=1)
                        
        all_sprites.add(LcarsText(colours.ORANGE, (0, 135), "USS LIBERTY", 1),
                        layer=1)
        all_sprites.add(LcarsBlockMedium(colours.RED_BROWN, (145, 16), "LIGHTS", self.testHandler),
                        layer=1)
        ...
        all_sprites.add(LcarsButton(colours.RED_BROWN, (6, 662), "LOGOUT", self.logoutHandler),
                        layer=4)
        all_sprites.add(LcarsButton(colours.BEIGE, (107, 127), "TEST", self.testHandler),
                        layer=4)
    ...
    def testHandler(self, item, event, clock):
        from screens.test import TestScreen 
        self.loadScreen(TestScreen())
